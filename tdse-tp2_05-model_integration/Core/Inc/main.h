...
#define LED_BARRIER_OPEN_Pin GPIO_PIN_10
#define LED_BARRIER_OPEN_GPIO_Port GPIOB
#define LED_BARRIER_CLOSE_Pin GPIO_PIN_8
#define LED_BARRIER_CLOSE_GPIO_Port GPIOA
